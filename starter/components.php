...
class component
{
    ...
    public static function eyebrow(mixed $args, mixed $classes = null, mixed $attributes = null): void
    {
        if (is_string($args)) {
            $args = ["eyebrow" => $args];
        }
        ...
        get_template_part('components/eyebrow/eyebrow', null, $args);
    }
    ...
    public static function picture(mixed $args, mixed $sizes = "full", mixed $classes = "", bool $lazy = true, bool $placeholder = false, int $breakpoint = 768, bool $preload = false): void
    {
        // $sizes accepte :
        ...
        if (is_array($args)) {
            ...
            $preload = !empty($args["preload"]) || $preload;
            $placeholder = array_key_exists("placeholder", $args) ? (bool) $args["placeholder"] : $placeholder;
            $breakpoint = isset($args["breakpoint"]) ? (int) $args["breakpoint"] : $breakpoint;
            $classes = $classes !== "" ? $classes : (string) ($args["classes"] ?? "");
    ...
    public static function marquee(mixed $items, mixed $direction = "left", mixed $classes = null, mixed $attributes = null): void
    {
        if (!is_array($items) || empty($items)) return;

        $args = array_key_exists("items", $items) ? $items : ["items" => $items];
        ...
        get_template_part('components/marquee/marquee', null, $args);
    }

    public static function newsletter(mixed $args = [], mixed $classes = null, mixed $attributes = null): void
    {
        $args = is_array($args) ? $args : ["title" => $args];
        ...
        get_template_part('components/newsletter/newsletter', null, $args);
    }

    public static function filters(mixed $args, mixed $classes = null, mixed $attributes = null): void
    {
        if (!is_array($args)) return;
        ...
        get_template_part('components/filters/filters', null, $args);
    }

    public static function pagination(mixed $args, mixed $classes = null, mixed $attributes = null): void
    {
        if (!is_array($args)) return;
        ...
        get_template_part('components/pagination/pagination', null, $args);
    }
    ...
    public static function notification(mixed $message, mixed $type = "info", mixed $classes = null, mixed $attributes = null): void
    {
        $args = is_array($message) ? $message : [
            "message" => $message,
            "type" => $type,
            "classes" => $classes,
            "attributes" => $attributes,
        ...
        if (!is_array($message)) {
            get_template_part('components/notification/notification', '', $args);
            return;
        }
    ...
    public static function select_lang(mixed $languages, mixed $label = null, mixed $classes = null, mixed $attributes = null): void
    {
        if (!is_array($languages) || empty($languages)) return;

        $args = isset($languages["languages"]) || isset($languages["args"])
            ? $languages
            : ["languages" => $languages];
        ...
        get_template_part('components/select-lang/select-lang', '', $args);
    }
