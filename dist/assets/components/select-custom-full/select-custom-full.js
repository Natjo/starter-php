class SelectCustom {
  constructor(root) {
    var _root$dataset$placeho, _root$dataset;
    if (!(root instanceof HTMLElement)) return;
    if (root.__selectCustomInstance) return root.__selectCustomInstance;
    this.root = root;
    ...
    this.placeholder = (_root$dataset$placeho = (_root$dataset = root.dataset) === null || _root$dataset === void 0 ? void 0 : _root$dataset.placeholder) !== null && _root$dataset$placeho !== void 0 ? _root$dataset$placeho : "";
    this._cleanups = [];
    ...
    root.__selectCustomInstance = this;
  }
  _isOpen() {
  ...
  _selectOption(opt, {
    ...
    var _opt$dataset$value, _opt$dataset;
    if (!opt || !this.options.includes(opt)) return;
    if (opt.getAttribute("aria-disabled") === "true") return;
    this.options.forEach(o => {
      if (o === opt) o.setAttribute("aria-selected", "true");else o.removeAttribute("aria-selected");
    });
    const label = (opt.textContent || "").trim();
    const value = (_opt$dataset$value = (_opt$dataset = opt.dataset) === null || _opt$dataset === void 0 ? void 0 : _opt$dataset.value) !== null && _opt$dataset$value !== void 0 ? _opt$dataset$value : label;
  ...
  _updateButtonFromSelection() {
    ...
    const values = selected.map(o => {
      var _o$dataset$value, _o$dataset;
      return (_o$dataset$value = (_o$dataset = o.dataset) === null || _o$dataset === void 0 ? void 0 : _o$dataset.value) !== null && _o$dataset$value !== void 0 ? _o$dataset$value : (o.textContent || "").trim();
    }).filter(Boolean);
  ...
  _setValues(values) {
    if (this.inputsContainer) {
      ...
      this.inputsContainer.dispatchEvent(new Event("change", {
        bubbles: true
      }));
      return;
    }
  ...
  destroy() {
    ...
    this._cleanups = [];
    if (this.root) delete this.root.__selectCustomInstance;
  }
}
export default el => {
  if (!(el instanceof HTMLElement)) return;
  return new SelectCustom(el);
};