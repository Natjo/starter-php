...
La page `/admin/` genere les variantes avec Imagick directement dans `web/uploads`, a cote de l'image originale. Les images `jpg` et `png` sont converties en `webp`, et les crops sont toujours generes en `webp`.

Exemple :

```txt
web/uploads/photo.jpg
web/uploads/photo.webp
web/uploads/photo-130x87.webp
web/uploads/photo-card.webp
```
