...
const getInvalidMsgEl = field => {
  ...
  return (container === null || container === void 0 ? void 0 : container.querySelector(".invalid-msg")) || null;
};
...
const getDefaultErrorMessage = messageEl => {
  var _messageEl$dataset;
  return ((messageEl === null || messageEl === void 0 || (_messageEl$dataset = messageEl.dataset) === null || _messageEl$dataset === void 0 ? void 0 : _messageEl$dataset.default) || "").trim();
};
...
const getMandatoryMessage = field => {
  var _group$dataset;
  const group = field.closest('[role="group"]');
  return field.dataset.mandatory || (group === null || group === void 0 || (_group$dataset = group.dataset) === null || _group$dataset === void 0 ? void 0 : _group$dataset.mandatory) || "";
};
...
const getCustomFieldInvalidMsg = field => {
  var _field$closest;
  return ((_field$closest = field.closest(".field")) === null || _field$closest === void 0 ? void 0 : _field$closest.querySelector(".invalid-msg")) || field.querySelector(".invalid-msg") || null;
};
const getCustomFieldValue = field => {
  return Array.from(field.querySelectorAll("[data-field-value]")).map(input => input.value.trim()).filter(Boolean).join(",");
};
const FormValidate = function FormValidate(form, onSend) {
  ...
  const validateCustomField = field => {
    ...
    if (!valid) {
      ...
      const message = (field.dataset.mandatory || getDefaultErrorMessage(invalidMsg)).trim() || "Ce champ est obligatoire.";
  ...
  const validateGroup = group => {
    ...
    if (!valid) {
      ...
      firstInvalidControl || (firstInvalidControl = anchor);
      const msg = (group.dataset.mandatory || getDefaultErrorMessage(invalidMsg)).trim();
      const message = msg || (anchor === null || anchor === void 0 ? void 0 : anchor.validationMessage) || DEFAULT_GROUP_REQUIRED_MESSAGE;
  ...
  const validate = () => {
    ...
    for (const field of fields) {
      const group = field.closest('[role="group"]');
      if (group !== null && group !== void 0 && group.hasAttribute("data-required")) continue;
      field.setCustomValidity("");
      ...
      if (!field.checkValidity()) {
        firstInvalidControl || (firstInvalidControl = field);
  ...
  addListener(form, "submit", event => {
    ...
    if (validate()) {
      ...
      var _firstInvalidControl, _firstInvalidControl$;
      (_firstInvalidControl = firstInvalidControl) === null || _firstInvalidControl === void 0 || (_firstInvalidControl$ = _firstInvalidControl.focus) === null || _firstInvalidControl$ === void 0 || _firstInvalidControl$.call(_firstInvalidControl);
    }
  });
  api.destroy = () => {
